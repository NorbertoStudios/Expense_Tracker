...
import { navItems, navIconSize } from '../../constant/nav-items';
import  NsLogo from '../../public/NS_fox_logo.svg'
...
function Nav() {
  return (
    <>
      ...
      <div className="flex flex-col items-center w-60 h-screen overflow-hidden text-gray-400 bg-gray-900 ">
        <a className="flex items-center w-full px-3 mt-3" href="#">


          <Image className='rounded' src={"/NS_fox_outline.svg"} height={40} width={40}/>
        ...
        <div className="flex items-center justify-center w-full h-16 mt-2 bg-gray-800" >
          ...
          <div className="flex justify-center items-center space-x-2">
            <div>
              {/* <img className="rounded-full" src='/Ns' alt="avatar" /> */}
              <Image className="rounded-full bg-white" src={"/NS_fox_logo.svg"} height={40} width={40} />
            </div>
            <div className="flex justify-start flex-col items-start hover:text-gray-300 ">
              <p className="cursor-pointer text-sm leading-5 ">Norberto Studios</p>
              <p className="cursor-pointer text-xs leading-3 ">norbertostudios@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
